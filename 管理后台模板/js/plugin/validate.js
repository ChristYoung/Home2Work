...
(function(window, document, undefined) {
    ...
    var defaults = {
        ...
        messages: {
            ...
            less_than: '%s的值必须小于%s',
            greater_than_or_equal: '%s的值必须大于等于%s',
            less_than_or_equal: '%s的值必须大于等于%s',
            alpha: '%s只能输入字母.',
            ...
            decimal: '%s只能输入整数或小数.',
            is_natural: '%s只能输入自然数.',
            is_natural_no_zero: '%s必须为一个大于0的自然数',
            valid_ip: '请输入正确的ip地址',
    ...
    var ruleRegex = /^(.+?)\[(.+)\]$/,
        ...
        dateRegex = /\d{4}-\d{1,2}-\d{1,2}/, //形如2012-4-28　2012-04-28之类
    ...
    var FormValidator = function(formNameOrNode, fields, isSubmitGo, callback) {
        this.callback = callback || defaults.callback;
        this.isSubmitGo = isSubmitGo || defaults.isSubmitGo;
        this.errors = [];
    ...
    FormValidator.prototype._hooks = {
        ...
        greater_than_or_equal: function(field, param) {
        	if (!decimalRegex.test(field.value)) {
                return false;
            }
        ...
        less_than_or_equal: function(field, param) {
            if (!decimalRegex.test(field.value)) {
                return false;
            }
        ...
        no_space: function(field) {
        	return !spaceRegex.test(field.value);
        }
    };

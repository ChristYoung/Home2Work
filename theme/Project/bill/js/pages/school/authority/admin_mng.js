...
$reset_btn.on('click', function() {
	...
	$modalConfirmBtn.off().on('click', function() {
		...
		$.get(serverUrl + '/school/admin/resetPwd.ajax',{schoolId:schoolId},function(data) {
			if(data.success) {
...
$forbid_btn.on('click', function() { 
	...
	$modalConfirmBtn.off().on('click', function() {
		$modalDialog.modal('hide'); 
		$.get(serverUrl + '/school/admin/updateStatus.ajax',{schoolId:schoolId,status:'E'},function(data) {
			if(data.success) {
...
$enable_btn.on('click', function() { 
	var schoolId = $(this).attr('data-id');
	$.get(serverUrl + '/school/admin/updateStatus.ajax',{schoolId:schoolId,status:'D'},function(data) {
		if(data.success) {
...
$del_btn.on('click', function() { 
	...
	$modalConfirmBtn.off().on('click', function() {
		$modalDialog.modal('hide'); 
		$.post(serverUrl + '/school/admin/delete.ajax', {id:id}, function(data) {
			if(data.success) {

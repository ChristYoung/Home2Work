...
function(e) {
	...
	e.fn.xdsoftScroller = function(t) {
		return this.each(function() {
			...
			function(a) {
				...
				h = o[0].offsetHeight,
				"mousedown" === a.type ? (document && e(document.body).addClass("xdsoft_noselect"), e([document.body, window]).on("mouseup.xdsoft_scroller",
				function r() {
			...
			function(e, t, d) {
				...
				l > 1 ? i.hide() : (i.show(), i.css("height", parseInt(f > 10 ? f: 10, 10)), u = o[0].offsetHeight - i[0].offsetHeight, d !== !0 && s.trigger("scroll_element.xdsoft_scroller", [t || Math.abs(parseInt(a.css("marginTop"), 10)) / (r - n)]))
			}), s.on("mousewheel",
			function(e) {
	...
	e.fn.datetimepicker = function(n) {
		...
		//添加存取this变量，但如果是同时选取多个元素调用datetimepicker的话，会有问题，建议选择单个元素调用datetimepicker by:tsolong
		var oooooo = this;
		...
		O = 89,
		w = !1,
		_ = e.isPlainObject(n) || !n ? e.extend(!0, {},
		a, n) : e.extend(!0, {},
		a),
		W = 0,
		F = function(e) {
		...
		return o = function(a) {
			function o() {
				var e, t = !1;
				return _.startDate ? t = C.strToDate(_.startDate) : (t = _.value || (a && a.val && a.val() ? a.val() : ""), t ? t = C.strToDateTime(t) : _.defaultDate && (t = C.strToDateTime(_.defaultDate), _.defaultTime && (e = C.strtotime(_.defaultTime), t.setHours(e.getHours()), t.setMinutes(e.getMinutes())))),
			...
			//添加清空按钮的html  by:tsolong
			z = e('<div class="xdsoft_mounthpicker"><button type="button" class="xdsoft_prev"></button><button type="button" class="xdsoft_today_button"></button><button type="button" class="my_clear_button">清空</button><div class="xdsoft_label xdsoft_month"><span></span><i></i></div><div class="xdsoft_label xdsoft_year"><span></span><i></i></div><button type="button" class="xdsoft_next"></button></div>'),
			...
			z.find(".xdsoft_month,.xdsoft_year").on("mousedown.xdsoft",
			function(t) {
				...
				return r.xdsoftScroller(i / (r.children()[0].offsetHeight - r[0].clientHeight)),
				t.stopPropagation(),
				!1
			}),
			z.find(".xdsoft_select").xdsoftScroller().on("mousedown.xdsoft",
			function(e) {
				e.stopPropagation(),
				e.preventDefault()
			}).on("mousedown.xdsoft", ".xdsoft_option",
			function() { (void 0 === C.currentTime || null === C.currentTime) && (C.currentTime = C.now());
				...
				_.onChangeMonth && e.isFunction(_.onChangeMonth) && _.onChangeMonth.call(Y, C.currentTime, Y.data("input")),
				t !== C.currentTime.getFullYear() && e.isFunction(_.onChangeYear) && _.onChangeYear.call(Y, C.currentTime, Y.data("input"))
			}),
			Y.setOptions = function(n) {
				...
				n.highlightedPeriods && e.isArray(n.highlightedPeriods) && n.highlightedPeriods.length && (r = e.extend(!0, [], _.highlightedDates), e.each(n.highlightedPeriods,
				function(a, n) {
					var o, i, s, d, u, l, f;
					if (e.isArray(n)) o = n[0],
					i = n[1],
					s = n[2],
					f = n[3];
					else {
					...
					for (; i >= o;) d = new t(o, s, f),
					u = o.dateFormat(_.formatDate),
					o.setDate(o.getDate() + 1),
					void 0 !== r[u] ? (l = r[u].desc, l && l.length && d.desc && d.desc.length && (r[u].desc = l + "\n" + d.desc)) : r[u] = d
				}), _.highlightedDates = e.extend(!0, [], r)),
				n.disabledDates && e.isArray(n.disabledDates) && n.disabledDates.length && (_.disabledDates = e.extend(!0, [], n.disabledDates)),
				n.disabledWeekDays && e.isArray(n.disabledWeekDays) && n.disabledWeekDays.length && (_.disabledWeekDays = e.extend(!0, [], n.disabledWeekDays)),
				...
				_.dayOfWeekStart = isNaN(_.dayOfWeekStart) ? 0 : parseInt(_.dayOfWeekStart, 10) % 7,
				_.timepickerScrollbar || N.xdsoftScroller("hide"),
				_.minDate && /^[\+\-](.*)$/.test(_.minDate) && (_.minDate = C.strToDateTime(_.minDate).dateFormat(_.formatDate)),
				_.maxDate && /^[\+\-](.*)$/.test(_.maxDate) && (_.maxDate = C.strToDateTime(_.maxDate).dateFormat(_.formatDate)),
				E.toggle(_.showApplyButton),
				z.find(".xdsoft_today_button").css("visibility", _.todayButton ? "visible": "hidden"),
				z.find("." + _.prev).css("visibility", _.prevButton ? "visible": "hidden"),
				z.find("." + _.next).css("visibility", _.nextButton ? "visible": "hidden"),
				_.mask && (a.off("keydown.xdsoft"), _.mask === !0 && (_.mask = _.format.replace(/Y/g, "9999").replace(/F/g, "9999").replace(/m/g, "19").replace(/d/g, "39").replace(/H/g, "29").replace(/i/g, "59").replace(/s/g, "59")), "string" === e.type(_.mask) && (W(_.mask, a.val()) || a.val(_.mask.replace(/[0-9]/g, "_")), a.on("keydown.xdsoft",
				function(t) {
					...
					if (A >= s && d >= A || A >= u && l >= A || A === g || A === c) {
						...
						else if (n === _.mask.length) return t.preventDefault(),
						!1;
						for (n += A === g || A === c ? 0 : 1;
						/[^0-9_]/.test(_.mask.substr(n, 1)) && n < _.mask.length && n > 0;) n += A === g || A === c ? -1 : 1;
				...
				_.validateOnBlur && a.off("blur.xdsoft").on("blur.xdsoft",
				function() {
					if (_.allowBlank && !e.trim(e(this).val()).length) e(this).val(null),
					Y.data("xdsoft_datetime").empty();
						...
						e(this).val(!_.datepicker && _.timepicker && t >= 0 && 24 > t && a >= 0 && 60 > a ? [t, a].map(function(e) {
							return e > 9 ? e: "0" + e
						}).join(":") : C.now().dateFormat(_.format)),
			...
			Y.data("options", _).on("mousedown.xdsoft",
			function(e) {
			...
			i = function() {
				...
				t.now = function(e) {
					var a, n, r = new Date;
					return ! e && _.defaultDate && (a = t.strToDateTime(_.defaultDate), r.setFullYear(a.getFullYear()), r.setMonth(a.getMonth()), r.setDate(a.getDate())),
					_.yearOffset && r.setFullYear(r.getFullYear() + _.yearOffset),
					!e && _.defaultTime && (n = t.strtotime(_.defaultTime), r.setHours(n.getHours()), r.setMinutes(n.getMinutes())),
					r
				},
				...
				t.nextMonth = function() { (void 0 === t.currentTime || null === t.currentTime) && (t.currentTime = t.now());
					...
					return 12 === n && (t.currentTime.setFullYear(t.currentTime.getFullYear() + 1), n = 0),
					...
					_.onChangeMonth && e.isFunction(_.onChangeMonth) && _.onChangeMonth.call(Y, C.currentTime, Y.data("input")),
					a !== t.currentTime.getFullYear() && e.isFunction(_.onChangeYear) && _.onChangeYear.call(Y, C.currentTime, Y.data("input")),
					Y.trigger("xchange.xdsoft"),
					n
				},
			...
			z.find(".xdsoft_today_button").on("mousedown.xdsoft",
			function() {
				Y.data("changed", !0),
				C.setCurrentTime(0),
				Y.trigger("afterOpen.xdsoft")
			}).on("dblclick.xdsoft",
			function() {
				...
				e > n || (t = C.strToDate(_.maxDate), t = new Date(t.getFullYear(), t.getMonth(), t.getDate()), n > t || (a.val(C.str()), a.trigger("change"), Y.trigger("close.xdsoft")))
			}),
			//绑定清空按钮事件  by:tsolong
			z.find(".my_clear_button").on("mousedown.xdsoft",
			function(){
				$(oooooo).val('');
				Y.trigger("close.xdsoft");
			});
			z.find(".xdsoft_prev,.xdsoft_next").on("mousedown.xdsoft",
			function() {
				var t = e(this),
				a = 0,
				n = !1; !
			...
			I.find(".xdsoft_prev,.xdsoft_next").on("mousedown.xdsoft",
			function() {
				var t = e(this),
				a = 0,
				n = !1,
				...
				function o(e) {
					...
					t.hasClass(_.next) && s - i - _.timeHeightInTimePicker >= d ? L.css("marginTop", "-" + (d + _.timeHeightInTimePicker) + "px") : t.hasClass(_.prev) && d - _.timeHeightInTimePicker >= 0 && L.css("marginTop", "-" + (d - _.timeHeightInTimePicker) + "px"),
					N.trigger("scroll_element.xdsoft_scroller", [Math.abs(parseInt(L.css("marginTop"), 10) / (s - i))]),
					r = r > 10 ? 10 : r - 10,
				...
				function i() {
					clearTimeout(a),
					n = !0,
					e([document.body, window]).off("mouseup.xdsoft", i)
				})
			}),
			W = 0,
			Y.on("xchange.xdsoft",
			function(t) {
				clearTimeout(W),
				W = setTimeout(function() { (void 0 === C.currentTime || null === C.currentTime) && (C.currentTime = C.now());
					for (var t, a, o, i, s, d, u, l, f, c, h = "",
					m = new Date(C.currentTime.getFullYear(), C.currentTime.getMonth(), 1, 12, 0, 0), g = 0, p = C.now(), y = !1, D = !1, v = [], b = !0, x = "", k = ""; m.getDay() !== _.dayOfWeekStart;) m.setDate(m.getDate() - 1);
					for (h += "<table><thead><tr>", _.weeks && (h += "<th></th>"), t = 0; 7 > t; t += 1) h += "<th>" + _.i18n[r].dayOfWeekShort[(t + _.dayOfWeekStart) % 7] + "</th>";

					for (h += "</tr></thead>", h += "<tbody>", _.maxDate !== !1 && (y = C.strToDate(_.maxDate), y = new Date(y.getFullYear(), y.getMonth(), y.getDate(), 23, 59, 59, 999)), _.minDate !== !1 && (D = C.strToDate(_.minDate), D = new Date(D.getFullYear(), D.getMonth(), D.getDate())); g < C.currentTime.countDaysInMonth() || m.getDay() !== _.dayOfWeekStart || C.currentTime.getMonth() === m.getMonth();) v = [],
					g += 1,
					o = m.getDay(),
					i = m.getDate(),
					s = m.getFullYear(),
					...
					c = "",
					v.push("xdsoft_date"),
					l = _.beforeShowDay && e.isFunction(_.beforeShowDay.call) ? _.beforeShowDay.call(Y, m) : null,
					y !== !1 && m > y || D !== !1 && D > m || l && l[0] === !1 ? v.push("xdsoft_disabled") : -1 !== _.disabledDates.indexOf(m.dateFormat(_.formatDate)) ? v.push("xdsoft_disabled") : -1 !== _.disabledWeekDays.indexOf(o) && v.push("xdsoft_disabled"),
					l && "" !== l[1] && v.push(l[1]),
					C.currentTime.getMonth() !== d && v.push("xdsoft_other_month"),
					(_.defaultSelect || Y.data("changed")) && C.currentTime.dateFormat(_.formatDate) === m.dateFormat(_.formatDate) && v.push("xdsoft_current"),
					p.dateFormat(_.formatDate) === m.dateFormat(_.formatDate) && v.push("xdsoft_today"),
					(0 === m.getDay() || 6 === m.getDay() || -1 !== _.weekends.indexOf(m.dateFormat(_.formatDate))) && v.push("xdsoft_weekend"),
					void 0 !== _.highlightedDates[m.dateFormat(_.formatDate)] && (a = _.highlightedDates[m.dateFormat(_.formatDate)], v.push(void 0 === a.style ? "xdsoft_highlighted_default": a.style), c = void 0 === a.desc ? "": a.desc),
					_.beforeShowDay && e.isFunction(_.beforeShowDay) && v.push(_.beforeShowDay(m)),
					b && (h += "<tr>", b = !1, _.weeks && (h += "<th>" + u + "</th>")),
					h += '<td data-date="' + i + '" data-month="' + d + '" data-year="' + s + '" class="xdsoft_date xdsoft_day_of_week' + m.getDay() + " " + v.join(" ") + '" title="' + c + '"><div>' + i + "</div></td>",
					...
					if (h += "</tbody></table>", H.html(h), z.find(".xdsoft_label span").eq(0).text(_.i18n[r].months[C.currentTime.getMonth()]), z.find(".xdsoft_label span").eq(1).text(C.currentTime.getFullYear()), x = "", k = "", d = "", f = function(t, a) {
						...
						n.setMinutes(a),
						v = [],
						(_.minDateTime !== !1 && _.minDateTime > n || _.maxTime !== !1 && C.strtotime(_.maxTime).getTime() < o.getTime() || _.minTime !== !1 && C.strtotime(_.minTime).getTime() > o.getTime()) && v.push("xdsoft_disabled"),
						(_.minDateTime !== !1 && _.minDateTime > n || _.disabledMinTime !== !1 && o.getTime() > C.strtotime(_.disabledMinTime).getTime() && _.disabledMaxTime !== !1 && o.getTime() < C.strtotime(_.disabledMaxTime).getTime()) && v.push("xdsoft_disabled"),
						r = new Date(C.currentTime),
						r.setHours(parseInt(C.currentTime.getHours(), 10)),
						i || r.setMinutes(Math[_.roundTime](C.currentTime.getMinutes() / _.step) * _.step),
						(_.initTime || _.defaultSelect || Y.data("changed")) && r.getHours() === parseInt(t, 10) && (!i && _.step > 59 || r.getMinutes() === parseInt(a, 10)) && (_.defaultSelect || Y.data("changed") ? v.push("xdsoft_current") : _.initTime && v.push("xdsoft_init_time")),
						parseInt(p.getHours(), 10) === parseInt(t, 10) && parseInt(p.getMinutes(), 10) === parseInt(a, 10) && v.push("xdsoft_today"),
						x += '<div class="xdsoft_time ' + v.join(" ") + '" data-hour="' + t + '" data-minute="' + a + '">' + o.dateFormat(_.formatTime) + "</div>"
					},
					_.allowTimes && e.isArray(_.allowTimes) && _.allowTimes.length) for (g = 0; g < _.allowTimes.length; g += 1) k = C.strtotime(_.allowTimes[g]).getHours(),
					d = C.strtotime(_.allowTimes[g]).getMinutes(),
					f(k, d);
					else for (g = 0, t = 0; g < (_.hours12 ? 12 : 24); g += 1) for (t = 0; 60 > t; t += _.step) k = (10 > g ? "0": "") + g,
					d = (10 > t ? "0": "") + t,
					f(k, d);
			...
			function() {
				if (_.timepicker) {
					var e, t, a, n;
					L.find(".xdsoft_current").length ? e = ".xdsoft_current": L.find(".xdsoft_init_time").length && (e = ".xdsoft_init_time"),
					e ? (t = N[0].clientHeight, a = L[0].offsetHeight, n = L.find(e).index() * _.timeHeightInTimePicker + 1, n > a - t && (n = a - t), N.trigger("scroll_element.xdsoft_scroller", [parseInt(n, 10) / (a - t)])) : N.trigger("scroll_element.xdsoft_scroller", [0])
				}
			}),
			F = 0,
			H.on("click.xdsoft", "td",
			function(t) {
				t.stopPropagation(),
				F += 1;
				var n = e(this),
				r = C.currentTime;
				return (void 0 === r || null === r) && (C.currentTime = C.now(), r = C.currentTime),
			...
			L.on("click.xdsoft", "div",
			function(t) {
				t.stopPropagation();
				var a = e(this),
				n = C.currentTime;
				return (void 0 === n || null === n) && (C.currentTime = C.now(), n = C.currentTime),
			...
			Y.on("changedatetime.xdsoft",
			function(t) {
				if (_.onChangeDateTime && e.isFunction(_.onChangeDateTime)) {
					var a = Y.data("input");
					_.onChangeDateTime.call(Y, C.currentTime, a, t),
					delete _.value,
					a.trigger("change")
				}
			}).on("generate.xdsoft",
			function() {
				_.onGenerate && e.isFunction(_.onGenerate) && _.onGenerate.call(Y, C.currentTime, Y.data("input")),
			...
			P = function() {
				...
				r = a.left,
				o = "absolute";
				"rtl" == Y.data("input").parent().css("direction") && (r -= Y.outerWidth() - Y.data("input").outerWidth()),
				_.fixed ? (n -= e(window).scrollTop(), r -= e(window).scrollLeft(), o = "fixed") : (n + Y[0].offsetHeight > e(window).height() + e(window).scrollTop() && (n = a.top - Y[0].offsetHeight + 1), 0 > n && (n = 0), r + Y[0].offsetWidth > e(window).width() && (r = e(window).width() - Y[0].offsetWidth)),
				t = Y[0];
				do
			...
			function(t) {
				var a = !0;
				_.onShow && e.isFunction(_.onShow) && (a = _.onShow.call(Y, C.currentTime, Y.data("input"), t)),
				a !== !1 && (Y.show(), P(), e(window).off("resize.xdsoft", P).on("resize.xdsoft", P), _.closeOnWithoutClick && e([document.body, window]).on("mousedown.xdsoft",
				function n() {
					Y.trigger("close.xdsoft"),
			...
			function(t) {
				...
				_.onClose && e.isFunction(_.onClose) && (a = _.onClose.call(Y, C.currentTime, Y.data("input"), t)),
			...
			Y.setOptions(_),
			C.setCurrentTime(o()),
			a.data("xdsoft_datetimepicker", Y).on("open.xdsoft focusin.xdsoft mousedown.xdsoft",
			function() {
		...
		this.each(function() {
			...
			if (a) {
				...
				case "reset":
					...
					this.value && a.data("xdsoft_datetime").isValidDate(Date.parseDate(this.value, _.format)) || a.data("changed", !1),
...
function(e) {
	...
	"use strict";
	function e(e) {
		for (var a = [], n = !1, r = "", i = 0; i < e.length; ++i) r = e.charAt(i),
	...
	function n(e) {
		for (var t, n = d.length,
		i = 1,
		u = "",
		l = !1,
		f = "",
		c = [], h = 0; h < e.length; ++h) f = e.charAt(h),
		l || "\\" !== f ? l ? (l = !1, u += o(f)) : (t = r(f, i), i += t.g, u += t.s, t.g && t.a && c.push(t.a)) : l = !0;
		d[n] = new RegExp("^" + u + "$"),
		s[e] = a(e, n, c)
	}
	function r(e, t) {

var popWindow = {
	...
	liDom:'',
	options:{_list:[],title:'',relateDom:$('.rep_type'),clTag:true,callBack:null},  //配置参数,_list表示具体的选择项,relateDom表示进行数据绑定的相关dom,clTag表示是否允许为选项字体添加颜色,callBack表示点击具体的选项时的回调函数

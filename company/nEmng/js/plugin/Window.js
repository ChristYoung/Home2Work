						...
						renderUI:function(){
							...
							switch(this.cfg.winType){
								case 'alert':
								      ...
								      break;
								case 'confirm':
								     footContent = '<input type="button" value="'+this.cfg.text4ConfirmBtn+'" class="emng-btn btn-bg-blue window_confirmBtn"><input type="button" value="'+this.cfg.text4CancelBtn+'" class="window_cancelBtn">';
								     break;
								case 'prompt':   
								     ...
								     footContent = '<input type="button" value="'+this.cfg.text4PromptBtn+'" class="emng-btn btn-bg-blue window_promptBtn"><input type="button" value="' +
